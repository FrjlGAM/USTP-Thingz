...
import Terms from './Terms'; // Make sure path is correct
    ...
    <div className="registration-overlay">
      ...
      <div className="registration-popup">
        ...
        <div className="terms-checkbox">
          ...
          />
          <label htmlFor="terms">
            I agree to the <button type="button" className="terms-link" onClick={() => setShowTerms(true)}>terms and conditions</button>
          </label>
        </div>
